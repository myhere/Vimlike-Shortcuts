Vimlike-Shortcuts - Power your website with vimlike shortcuts
=============================================================

What's this?  
------------

Vimlike-Shortcuts powers you vimlkie keyboard shortcuts when suffering the
...
You should load this script `http://up-coming.com/vimlike-shorcuts.js` before using this shortcuts!
...
If you have problem while using this or just wanna give an advice, please feel
