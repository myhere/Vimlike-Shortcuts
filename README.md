...
[demo](https://myhere.github.io/Vimlike-Shortcuts/demos/index.html)

How to use?  
----------- 

You should load this script `https://myhere.github.io/Vimlike-Shortcuts/build/vimlike-shortcuts.js` before using these shortcuts!
...
Simply add the code below to your websites' footer or header, you can also add a toggle button if you like.
    ...
    <script src="https://myhere.github.io/Vimlike-Shortcuts/build/vimlike-shortcuts.js" charset="utf-8"></script>
...
or
    ...
    <script> 
        !!v ? v.toggleVimlike() : (function(d, s) {
                ...
                s.charset = 'utf-8';
                s.src = 'https://myhere.github.io/Vimlike-Shortcuts/build/vimlike-shortcuts.js';
...
Just click this [link](https://myhere.github.io/Vimlike-Shortcuts/demos/index.html) and drag the
